        ...
        if check1 == 0:
            ...
            for file in all_files:
                ...
                fields = ['ship-address-1', 'Street', 'Town', 'Country', 'ship-postal-code', 'first_name', 'last_name',
                          ...
                          'Weight', 'Length', 'Width', 'Height', 'item-price', 'quantity-purchased', 'serviceid']
                rows = []
                ...
                for i in range(0, number_of_pages):
                    try:
                        ...
                        row = [address1, street, town, 'United Kingdom', postal, first_name, last_name, order_id,
                                   contents, sku, reference2, quantity, 5, 60, 45, 10, 20, 1, 'Standard Parcel']
                        rows.append(row)
                # writing to csv file
